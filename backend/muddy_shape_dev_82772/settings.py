"""
Django settings for muddy_shape_dev_82772 project.
...
ROOT_URLCONF = 'muddy_shape_dev_82772.urls'
...
WSGI_APPLICATION = 'muddy_shape_dev_82772.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_shape_dev_82772 API",
    "DESCRIPTION": "API documentation for muddy_shape_dev_82772 App",
    "VERSION": "v1",
}
